...
public class ControlDespachos {
	...
	/*
	public void ModificarDatosDeUnPedido(long numPedido)
	{
	  Scanner sc = new Scanner(System.in);

	  if(existePedido(long numPedido))
	  {
	    int opc=0;
	//System.out.println("");
	do{
	...
	*/
	...
	public void cambiarFecha(long numPedido)
	{
	  ...
	  {
		  long temp = ped.getSolicitante().getCedula();//identifico al cliente
	   Calendar temporal = ped.getFechaRecibido();
	  		}
